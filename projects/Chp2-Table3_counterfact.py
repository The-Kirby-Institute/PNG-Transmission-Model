...
excel_files = ["Baseline_Routine_2_NoDolutegravir.xlsx",
               "Baseline_Routine_2_WithDolutegravir.xlsx",
...
excel_files_labels = ["Counterfactual - No dolutegravir",
                      "Baseline", 
                      ##### POCVL only, without DR testing
...
baseline_file = "Baseline_Routine_2_NoDolutegravir.xlsx"
...
output_file_path = os.path.join(result_path, "Chapter 2 - Table 3_counterfactual.xlsx")
...
print('Remember to recall the last dataframe here')